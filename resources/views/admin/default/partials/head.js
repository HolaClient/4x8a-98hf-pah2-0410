module.exports = (a) => {
    ...
    <head>
        ...
        ${process.env.APP_ENV = "production" ? `<link href="/assets/tailwind.css" rel="stylesheet">` : `<script src="https://cdn.tailwindcss.com"></script>`}
        ...
        //if ('serviceWorker' in navigator) {window.addEventListener('load', function () {navigator.serviceWorker.register('/assets/common/worker.js');});}
        </script>
    </head>`
}