...
for (let i of routes) {
    buttons.push(`<button onclick="render('${i.url}', 'page')" class="${btnClass}"> ${genSVG(i.icon)} <span>${i.display}</span> </button>`)
}
function genSVG(a) {
