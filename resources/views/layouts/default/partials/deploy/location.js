...
<label class="text-gray-400 text-left text-sm">Server location:
<select id="location" hcx-type="deploy.config" name="location" class="w-full mt-1 bg-zinc-950/50 focus:bg-zinc-950/80 focus:duration-300 duration-300 backdrop-blur-xl rounded-lg outline-none border border-zinc-800/80 p-2 px-3 items-center text-left text-gray-300">
    ${b.join('')}
</select>
</label>
</div>
