...
const API_KEY = settings.features.cloudflare.api_key;
const EMAIL = settings.features.cloudflare.email;
const ZONE_ID = settings.features.cloudflare.zone_id;
const DOMAIN = settings.features.cloudflare.domain;
